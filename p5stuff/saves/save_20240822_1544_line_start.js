...
function draw() {
  ...
  let c1 = "rgba(223, 172, 52, 0.5)"
  let c2 = "rgba(3, 143, 218, 0.5)"
  let c3 = "rgba(171, 47, 74, 0.5)"
  ...
  stroke(c1)
  traceBetweenPairs(point1, point2, center, true)
  traceBetweenPairs(point2, point3, center)
  traceBetweenPairs(point4, point3, center, true)
  traceBetweenPairs(point4, point1, center)
   ...
   dist = 80;
   point1 = [width / 2, dist];
   point2 = [width - dist, height / 2];
   point3 = [width / 2 , height - dist]
   point4   = [dist, height / 2];
...
function traceBetweenPairs(p1, p2, center, withEndLines = false) {
  let line1 = []
  let line2 = []
  ...
  for (let i = (withEndLines ? 0 : 1); i < line1.length - (withEndLines ? 0 : 1); i++) {
