...
var waveSizeDiff = 50;
var waveSizeDiffMin = 0;
var waveSizeDiffMax = 300;
var waveSizeDiffStep = 5;
...
var horiPadding = -20;
var horiPaddingMin = -100;
var horiPaddingMax = 300;
var horiPaddingStep = 1;
...
function setup() {
  // [594, 840]
  // [4600, 2600]
  // const a1Format = [2245*340/594, 3178]
  // const a1Format = [1889, 2648]
  const scale = 0.2;
  const a1Format = [1889*2400/594*scale, 2648*2600/840*scale]
...
function draw() {
  ...
  stroke("#e8e044")
  drawVoronoiCurve(noise, waveSize-(waveSizeDiff *2));

  stroke("#ea2727")
  drawVoronoiCurve(noise, waveSize-(waveSizeDiff));
...
function drawVoronoiCurve(noise, waveSize, yOffsetFunc = 0) {
  ...
  lines.forEach((line, i) => {
    line.forEach((point, lineI) => {
      ...
      if (point[1] <= horiPadding || point[1] >= height - horiPadding ) delete line[lineI];
    })
  })
